...
function titile($form,$id,$page){
	...
	$div.="<a href='../../houtai.php'>后台管理></a><a href='xiazai.php?form=xiazai-gonggao'>资料共享></a>";
	switch($form){
			case "xiazai-gonggao":$div.="<a href='xiazai.php?form=xiazai-gonggao&page=".$page."'>相关公告></a><span>".$get_row."</span></div>";break;
			case "xiazai-ziliao":$div.="<a href='xiazai.php?form=xiazai-ziliao&page=".$page."'>相关资料></a><span>".$get_row."</span></div>";break;
			case "xiazai-qikan":$div.="<a href='xiazai.php?form=xiazai-qikan&page=".$page."'>电子期刊></a><span>".$get_row."</span></div>";break;
