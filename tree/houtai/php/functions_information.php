...
function left_nav($form){
	$nav0_first="<p class='p2'>资讯信息</p>";
	$nav0="<p class='p3'><a  href='information.php?form=information-gonggao'>通知公告<span>></span></a></p>";
	$nav1="<p class='p3'><a href='information.php?form=information-new'>行业动态<span>></span></a></p>";
	$nav2="<p class='p3'><a href='information.php?form=information-falv'>法律法规<span>></span></a></p>";
	//--------------------------------------------------------------------------------------
	switch($form){
		case "information-gonggao":$nav0="<p class='p3'><a class='active' href='information.php?form=information-gonggao'>通知公告<span>></span></a></p>";break;
		case "information-new":$nav1="<p class='p3'><a class='active' href='information.php?form=information-new'>行业动态<span>></span></a></p>";break;
		case "information-falv":$nav2="<p class='p3'><a class='active' href='information.php?form=information-falv'>法律法规<span>></span></a></p>";break;
		default:$nav0="<p class='p3'><a class='active' href='information.php?form=information-gonggao'>通知公告<span>></span></a></p>";break;
	}
	$nav_all=$nav0_first;
	$nav_all.=$nav0;
	$nav_all.=$nav1;
...
function nei_nav($form){
	switch($form){
		...
		default:$nav="<span>通知公告</span>";break;
	}
	echo $nav;		
}
//-------------------------------------------------------------------
