	...
	if($nav==1){
			$li="<table border='0' cellspacing='0'>";
				$li.="<tr class='tr1' bgcolor='#594b48'>
					...
					<td class='td_content'>number</td>
					<td class='td_content1'>bianhao</td>
					<td class='td_content'>shuming</td>
					<td class='td_time'>usefor</td>
...
function all_enty($form,$page,$module){
	switch($module){
		...
		case "ziyuan":ziyuan($form,$page,$module);break;
