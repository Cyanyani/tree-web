...
function ziyuan($form,$id,$page,$module){
	...
	if($nav==1){
		...
		if($res){
			$div.="<div class='d1'><p>id</p><textarea name='id' rows='1' cols='35'>".$res['id']."</textarea></div>";
			$div.="<div class='d1'><p>name</p><textarea name='name' rows='2' cols='35'>".$res['title']."</textarea></div>";
			$div.="<div class='d1'><p>huzhao</p><textarea name='canshu' rows='10' cols='35'>".$res['huzhao']."</textarea></div>";
			$div.="<div class='d1'><p>number</p><textarea name='time' rows='1' cols='35'>".$res['number']."</textarea></div>";
			$div.="<div class='d1'><p>base</p><textarea name='chanping' rows='10' cols='35'>".$res['base']."</textarea></div>";
			$div.="<div class='d1'><p>zhuyi</p><textarea name='zhuyi' rows='10' cols='35'>".$res['share']."</textarea></div>";
			
			$div.="<div class='d1'><p>shiyong</p><textarea name='shiyong' rows='4' cols='35'>".$res['xiangmu']."</textarea></div>";
			
			$div.="<div class='d1'><p>fangzhi</p><textarea name='fangzhi' rows='4' cols='35'>".$res['danwei']."</textarea></div>";
