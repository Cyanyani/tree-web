...
<link rel="stylesheet" href="../css/knowledge/knowledge.css" type="text/css" /><!--本网页的css样式-->
<?php include("../php/functions_knowledge.php") ?><!--资讯-函数库-->
</head>
...
<body>
		...
		<div id="all-content">
			...
			<div id="right-content">
				<div id="con_one_1">
					<iframe src='knowledge_iframe.php?form=knowledge-baike&page=<?php echo $page;?>' width="814" height="800" frameborder='0' scrolling='no' ></iframe>
				</div>
				
				<div id="con_one_2">
					<iframe src='knowledge_iframe.php?form=knowledge-yuzhong&page=<?php echo $page;?>' width="800" height="800" frameborder='0' scrolling='no' ></iframe>
				</div>
				
				<div id="con_one_3">
					<iframe src='knowledge_iframe.php?form=knowledge-yinzhong=<?php echo $page;?>' width="800" height="800" frameborder='0' scrolling='no' ></iframe>
				</div>
			</div>
