...
<link rel="stylesheet" href="../css/information/information_detail.css" type="text/css" /><!--本网页的css样式-->
...
<body>
	...
	<!-------------------------------------------------------->
			...
			<div class="top-menu">
				<ul class="nav1" id="all_title">
					...
					<li class="li1">
						...
						<ul class="nav20">
							<li class="li2"><a href="information.php?form=infromation-new&page=1">行业动态</a></li>
							<li class="li2"><a href="information.php?form=infromation-gonggao&page=1">通知公告</a></li>
							<li class="li2"><a href="information.php?form=infromation-falv&page=1">法律法规</a></li>
						</ul>
					</li>
		...
		<!--去掉4个像素-->
    	<div style="width: 1004px; height: 4px; background: #e8e8e8;margin:0px auto;"></div>
		<!--||导航栏-（首页）end>-->
