...
function titile($form){
	...
	$div.="<a href='../houtai.php' target='_blank'>后台管理></a><span>知识库></span>";
	switch($form){
...
function  fengye($form,$page){
	...
	while($row=mysql_fetch_array($result)){
			$li.="<li><a href='knowledge_detail.php?form=".$_GET["form"]."&id=";
			$li.=$row["id"];
			$li.="' target='_blank'><img src='../../knowledge/";
			$li.=$row["picture"];
			$li.="'></a>";
			//-----------------------------------------------------
			$li.="<a class='tit' href='knowledge_detail.php?form=".$_GET["form"]."&id=".$row["id"];
			$li.="&page=".$_GET["page"];
			$li.="' target='_blank'>";
			//判断tite字符串长度
			...
			$li.="</a>";
			//-----------------------------------------------------
			$li.="<a class='cont' href='knowledge_detail.php?form=".$_GET["form"]."&id=".$row["id"];
			$li.="&page=".$_GET["page"];
			$li.="' target='_blank'>";
			//判断content字符串长度
