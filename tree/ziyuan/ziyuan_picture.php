...
<link type="text/css" rel="stylesheet" href="../css/zzsc.css"></link>
<link rel="stylesheet" href="../css/ziyuan/ziyuan_picture.css" type="text/css" /><!--本网页的css样式-->
<?php include("../php/functions_ziyuan_picture.php") ?><!--首页-函数库-->
<!--js样式star-->
...
<body>
		...
		<div id="bg">
			<div class="top-menu">
				<ul class="nav1" id="all_title">
					...
					<li class="li1">
					<a href="ziyuan.php" class="width4 a1 active">种质资源</a>
		...
		<div id="all-content">
    		...
    		<!--内容-->
    		 ...
    		 <div class="iframe_ziyuan">
				<iframe src="ziyuan_iframe.php?id=<?php echo $id; ?>&page=<?php echo $page; ?>" id="iframepage" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" onLoad="iFrameHeight()"></iframe>
			</div> 
    		</div>
    	</div>
			<!---------------------总内容end--------------------------------->
		<script src="../js/information/jquery-1.8.3.min.js"></script>
		<script src="../js/information/jquery.PrintArea.min.js"></script> 
