...
<?php include("../php/functions_ziyuan.php") ?><!--首页-函数库-->
<!--js样式star-->
...
<body>
		...
		<div id="all-content">
			...
			<!--搜索栏star-->
			<div id="search">
				<form method="get" action="ziyuan.php" name="search_form" >
					<div class="input1">
						<input type="text" name="search"  placeholder="请输入关键词搜索"
						value="<?php echo $search ?>"/>
					</div>
					<div class="input2">
						<input type="submit" name="submit" value='搜索资源'/>
					</div>
				</form>
				<div class="hot">
					<span>热门搜索：</span>
					<a href="ziyuan.php?search=三叶木通">三叶木通</a>
					<a href="ziyuan.php?search=黑果枸杞">黑果枸杞</a>
					<a href="ziyuan.php?search=火力楠">火力楠</a>
				</div>
			</div>
			<!--搜索栏end-->
			
			<div class="content">
				<?php ziyuan($form,$page,$search); ?>
