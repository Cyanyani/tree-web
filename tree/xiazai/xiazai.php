		...
		<div id="bg">
			<div class="top-menu">
				<ul class="nav1" id="all_title">
					...
					<li class="li1">
					<a href="xiazai.php" class="width4 a1 active">资料共享</a>
						<ul class="nav21">
			...
			<div id="left-nav">
				...
				<div id="all1">
					<p class='p3' id="one1" onclick="setTab('one',1)">
						<a href="xiazai.php?form=xiazai-gonggao">相关公告<span>></span></a>
					</p>
					<p class='p3' id="one2" onclick="setTab('one',2)">
						<a href="xiazai.php?form=xiazai-ziliao">相关资料<span>></span></a>
					</p>
					<p class='p3' id="one3" onclick="setTab('one',3)">
						<a href="xiazai.php?form=xiazai-qikan">电子期刊<span>></span></a>
					</p>
				</div>
