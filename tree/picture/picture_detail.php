...
<link rel="stylesheet" href="../css/picture/picture_detail.css" type="text/css" /><!--本网页的css样式-->
<link type="text/css" rel="stylesheet" href="../css/zzsc.css"></link>

<?php include("../php/functions_picture_detail.php") ?><!--首页-函数库-->
<!--js样式star-->
		...
		<div id="bg">
			<div class="top-menu">
				<ul class="nav1" id="all_title">
					...
					<li class="li1">
					<a href="picture.php" class="width3 a1 active">图片库</a>
					</li>
